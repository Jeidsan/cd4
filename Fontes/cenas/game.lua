...
local function createGamer(group)
  ...
  gamer1 = display.newImageRect(group, "./imagens/ponto.jpg", 150, 150)--sheetInfo:getFrameIndex("gamer0"), 150, 150)
  gamer1.x = 150
  gamer1.y = display.contentHeight - 275

  gamer2 = display.newImageRect(group, "./imagens/ponto2.jpg", 150, 150)--sheetInfo:getFrameIndex("gamer1"), 150, 150)
  gamer2.x = 150
  gamer2.y = display.contentHeight - 275

  gamer3 = display.newImageRect(group, "./imagens/ponto.jpg", 150, 150)--sheetInfo:getFrameIndex("gamer2"), 150, 150)
  gamer3.x = 150
...
local function createInfo(infoGroup)
  ...
  --[[sheetInfo:getFrameIndex("lives")]]
  --[[sheetInfo:getWidth(sheetInfo:getFrameIndex("lives"))]]
  --[[sheetInfo:getHeight(sheetInfo:getFrameIndex("lives"))]]
  imgLives = display.newImageRect(infoGroup, "./imagens/ponto.jpg", 100, 100)
  imgLives.x = 100
  imgLives.y = 100
  ...
  --sheetInfo:getFrameIndex("energy")
  --sheetInfo:getWidth(sheetInfo:getFrameIndex("energy"))
  --sheetInfo:getHeight(sheetInfo:getFrameIndex("energy"))
  imgEnergy = display.newImageRect(infoGroup, "./imagens/ponto.jpg", 100, 100)
  ...
  --sheetInfo:getFrameIndex("score")
  --sheetInfo:getWidth(sheetInfo:getFrameIndex("score"))
  --sheetInfo:getHeight(sheetInfo:getFrameIndex("score"))
  imgScore = display.newImageRect(infoGroup, "./imagens/ponto.jpg", 100, 100)
...
local function createControl(group)
  ...
  --imgSheet, sheetInfo:getFrameIndex("btnUp")
  local btnUp = display.newImageRect(group, "./imagens/ponto.jpg", 64, 64)
  btnUp.x = 100
  btnUp.y = display.contentHeight - 100
  btnUp:addEventListener("tap", up)

  -- Cria o botão de atirar
  --imgSheet, sheetInfo:getFrameIndex("btnDown")
  local btnDown = display.newImageRect(group, "./imagens/ponto.jpg", 64, 64)
  btnDown.x = display.contentWidth - 100
  btnDown.y = display.contentHeight - 100
  btnDown:addEventListener("tap", down)

  -- Cria o botão fechar
  --imgSheet, sheetInfo:getFrameIndex("btnClose")
  local btnClose = display.newImageRect(group, "./imagens/ponto.jpg", 64, 64)
...
local function createObstacle()
  ...
  -- Sorteio a posição
  local position = math.random(2, 2) -- 1 = cima;  2 = baixo

  -- Crio o objeto
  local obstacle = display.newImageRect(infoGroup, "./imagens/ponto.jpg", 50, 50) --imgSheet, nrObstacle, sheetInfo:getWidth(nrObstacle) * 1.3, sheetInfo:getHeight(nrObstacle) * 1.3)
...
local function createQuestion()
  ...
  -- Crio o objeto
  local question = display.newImageRect(infoGroup, "./imagens/ponto.jpg", 50, 50)--imgSheet, nrQuestion, sheetInfo:getWidth(nrQuestion) * 1.3, sheetInfo:getHeight(nrQuestion) * 1.3)
